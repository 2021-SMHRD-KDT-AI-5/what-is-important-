...
public class dryerDTO {
	...
	private String antibacterial_function;
	private String product_capacity
;
	
	public dryerDTO(String product_num, String product_madeBy, String product_name, 
			String energy_rank, String counsum_E, String product_price,
			String product_type, String antibacterial_function,  String product_capacity) {
		...
		this.antibacterial_function = antibacterial_function;
	...
	public String getantibacterial_function() {
		return antibacterial_function;
	}



	public void setantibacterial_function(String antibacterial_function) {
		this.antibacterial_function = antibacterial_function;
	}
	...
	public void product_capacity(String product_capacity) {
		this.product_capacity = product_capacity;
	}
